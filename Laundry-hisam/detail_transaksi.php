...
<div class="main-content">
    <div class="topbar">
        ...
        <h6><i class="bi bi-file-text me-2"></i>Detail Transaksi</h6>
        <div class="ms-auto d-flex gap-2">
            <button onclick="window.print()" class="btn btn-outline-secondary btn-sm"><i class="bi bi-printer me-1"></i>Print</button>
            <a href="transaksi.php" class="btn btn-sm btn-outline-secondary"><i class="bi bi-arrow-left me-1"></i>Kembali</a>
        </div>
    </div>
    ...
    <div class="row g-4">
        <div class="col-md-5">
            <div class="card">
                <div class="card-header-custom">
                    <h5><i class="bi bi-info-circle me-2"></i>Info Transaksi</h5>
                ...
                <div class="card-body p-3">
                    <table class="table table-sm mb-0">
                        ...
                        <tr>
                            ...
                            <td><?= date('d F Y H:i', strtotime($trx['tgl'])) ?></td>
                        </tr>
                        <tr>
                            <td class="text-muted">Batas Waktu</td>
                            <td><?= date('d F Y H:i', strtotime($trx['batas_waktu'])) ?></td>
                        </tr>
                        <?php if ($trx['tgl_bayar']): ?>
                        <tr>
                            <td class="text-muted">Tgl Bayar</td>
                            <td><?= date('d F Y H:i', strtotime($trx['tgl_bayar'])) ?></td>
                        </tr>
                        <?php endif; ?>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>Rp <?= number_format($trx['pajak'], 0, ',', '.') ?></td>
                        </tr>
                    </table>
                </div>
            </div>
            ...
            <div class="mt-3">
                <a href="transaksi.php?status=<?= $next[$trx['status']] ?>&id=<?= $trx['id'] ?>"
                   ...
                   onclick="return confirm('Ubah status?')">
                    <i class="bi bi-arrow-right-circle me-1"></i><?= $nextLabel[$trx['status']] ?>
                </a>
            </div>
            <?php endif; ?>
        </div>
        ...
        <div class="col-md-7">
            <div class="card">
                <div class="card-header-custom">
                    <h5><i class="bi bi-list-ul me-2"></i>Rincian Item</h5>
                </div>
