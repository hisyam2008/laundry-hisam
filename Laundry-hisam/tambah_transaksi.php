...
$pakets  = $db->query("SELECT * FROM tb_paket ORDER BY nama_paket")->fetchAll();
$error   = '';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($id_pakets)) {
        ...
        $db->prepare("INSERT INTO tn_transaksi (kode_invoice, id_member, id_outlet, id_user, tgl, batas_waktu, tgl_bayar, biaya_tambahan, diskon, pajak, status, dibayar)
                      VALUES (?,?,?,?,?,?,?,?,?,?,'baru',?)")
        ...
        foreach ($id_pakets as $k => $id_paket) {
            ...
            $db->prepare("INSERT INTO tb_detain_transaksi (id_transaksi, id_paket, qty, keterangan) VALUES (?,?,?,?)")
            ...
            <div class="card-body p-4">
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="pajak" class="form-control" value="0" min="0" placeholder="0">
                    </div>
