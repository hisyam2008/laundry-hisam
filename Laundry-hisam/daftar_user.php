...
if (isset($_GET['hapus'])) {
    ...
    $db->prepare("DELETE FROM user WHERE id = ? AND username != 'admin'")->execute([$_GET['hapus']]);
    header('Location: daftar_user.php?msg=' . urlencode('User berhasil dihapus')); exit;
}

$users      = $db->query("SELECT u.id, u.nama, u.username, u.role, o.nama AS nama_outlet FROM user u LEFT JOIN tb_outlet o ON o.id = u.id_outlet ORDER BY u.id ASC")->fetchAll();
...
<div class="main-content">
    <div class="topbar">
        ...
        <h6><i class="bi bi-person-gear me-2"></i>Kelola User</h6>
    </div>
    ...
    <div class="card">
        <div class="card-header-custom">
            ...
            <div class="d-flex gap-2">
                <a href="tambah_user.php" class="btn btn-hijau btn-sm"><i class="bi bi-plus-lg me-1"></i>Tambah User</a>
            </div>
            <?php endif; ?>
        </div>
